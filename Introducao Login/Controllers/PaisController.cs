...
namespace Introducao_Login.Controllers
{
    public class PaisController : Controller
    {
        ...
        {
            return View(await _context.Paies.ToListAsync());
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var pais = await _context.Paies.SingleOrDefaultAsync(m => m.id == id);
            if (pais == null)
            {
                return NotFound();
            }
